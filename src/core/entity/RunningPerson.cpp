#include "RunningPerson.h"
#include <GL/glew.h>
#include <glm/gtc/matrix_transform.hpp>

RunningPerson::RunningPerson(const glm::vec2& position, const glm::vec4& color, float size)
    : Shape(position, color, 1.0f), m_size(size)
{
    ...
    m_vertices = {
        ...
        armLength, bodyHeight * 0.9f, // Right arm bottom (swung back)
        0.0f, bodyHeight * 0.7f,      // Left arm top
        -armLength, bodyHeight * 0.3f, // Left arm bottom (swung forward)
        
        // Legs (running position)
        0.0f, 0.0f,                  // Right leg top
        armLength, -legLength,        // Right leg bottom (swung forward)
        0.0f, 0.0f,                  // Left leg top
        -armLength, -legLength * 0.5f // Left leg bottom (swung back)
    };
