...
Dog::Dog(const glm::vec2& position, const glm::vec4& color, float size)
    : Shape(position, color, 1.0f), m_size(size)
{
    ...
    m_vertices = {
        ...
        // Head
        -bodySize, 0.0f,             // Head center (connected to body)
        -bodySize - headSize, 0.0f,   // Head left
        -bodySize - headSize, headSize, // Head top left
        -bodySize, headSize,          // Head top
        -bodySize + headSize * 0.5f, headSize * 0.5f, // Head right
        
        // Ears
        -bodySize, headSize,          // Head top (ear base)
        -bodySize - earSize * 0.5f, headSize + earSize, // Left ear
        -bodySize + earSize * 0.5f, headSize + earSize, // Right ear
